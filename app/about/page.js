          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '40px' }}>
            ...
            <div className="card">
              <div className="card-body" style={{ padding: '40px' }}>
                ...
                <p style={{ fontSize: '1.1rem', color: 'var(--text-color)', lineHeight: '1.8' }}>
                  Latest news, press releases, and campaign updates from the Unchi Awaaj Party.itutions are robust, transparency is the norm, and every citizen is empowered to achieve their full potential without the barriers of caste, creed, or economic background.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section section-light">
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ fontSize: '1.1rem', marginBottom: '20px' }}>
            The Unchi Awaaj Party (UAP) is rooted in the principles of Democratic Socialism and Secularism. We believe that true democracy goes beyond elections; it requires economic democracy where wealth is equitably distributed and workers have a say in their livelihoods.
          </p>
          ...
          <p style={{ fontSize: '1.1rem', marginBottom: '20px' }}>
            Founded in 2010 by Dr. Ananya Sharma alongside a coalition of social activists, trade union leaders, and reformist intellectuals, the UAP started as a mass movement in the central plains advocating for agrarian rights. 
          </p>
          <p style={{ fontSize: '1.1rem', marginBottom: '20px' }}>
